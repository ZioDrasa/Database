...
<form method = "post" action = "Modifica.php">
  <div style = "width: 450px; margin:0 auto; margin-top: 50px;">
    <div>
      <p style = "border-style: solid; border-radius: 10px; color: white; background-color: black; border-width: 0px; padding: 20px ; display: flex; justify-content: center"> Inserisci ID: &nbsp;&nbsp;<input type="text" name="ID"> <br>
    ...
    <div class = zoom>
        <div class = "card" style = "width: 180px; text-align:center; background-image: url('https://images.pexels.com/videos/3045163/free-video-3045163.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500')">
          <div class="grid-item"><button class = "card-body" type = "submit" name = "cancella" href = "cancellazione.php" style = "color: white; background-color: black"> Invia </button>
        </div></div>
    </div>
    </div>
  </div>
